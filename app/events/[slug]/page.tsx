      ...
      <div className="details">
        ...
        <div className="content">
          ...
          <section className="flex-col-gap-2">
            ...
            <EventDetailItem icon="/icons/pin.svg" alt="mode" label={location} />
        ...
        {/* Right Side - Form Content */}
          ...
          <aside className="booking">
            <div className="signup-card">
              ...
              {bookings > 0 ? (
                <p className="text-sm">
                  Join <b>{bookings}</b> others who have booked for this event. Don&apos;t miss out on an amazing experience!
                </p>
              ): (
